"""SQLAlchemy 2.0 ORM model for the model_detail_attribute table. AUTO-GENERATED — do not edit manually."""
...
class ModelDetailAttribute(Base):
    __tablename__ = "model_detail_attribute"
