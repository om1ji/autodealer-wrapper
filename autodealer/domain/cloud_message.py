"""SQLAlchemy 2.0 ORM model for the cloud_message table. AUTO-GENERATED — do not edit manually."""
...
class CloudMessage(Base):
    __tablename__ = "cloud_message"

    # WARNING: No primary key in schema — first column used as pseudo-PK
    cloud_message_id: Mapped[int] = mapped_column(Integer, primary_key=True)
