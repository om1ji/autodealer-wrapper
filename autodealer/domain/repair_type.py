"""SQLAlchemy 2.0 ORM model for the repair_type table. AUTO-GENERATED — do not edit manually."""
...
class RepairType(Base):
    ...
    repair_type_id: Mapped[int] = mapped_column(Integer, primary_key=True)
