"""SQLAlchemy 2.0 ORM model for the car_body_type table. AUTO-GENERATED — do not edit manually."""
...
class CarBodyType(Base):
    ...
    car_body_type_id: Mapped[int] = mapped_column(Integer, primary_key=True)
