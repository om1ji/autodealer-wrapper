"""SQLAlchemy 2.0 ORM model for the car_fuel_type table. AUTO-GENERATED — do not edit manually."""
...
class CarFuelType(Base):
    ...
    car_fuel_type_id: Mapped[int] = mapped_column(Integer, primary_key=True)
