"""SQLAlchemy 2.0 ORM model for the service_complex_goods table. AUTO-GENERATED — do not edit manually."""
...
class ServiceComplexGoods(Base):
    __tablename__ = "service_complex_goods"

    service_complex_goods_id: Mapped[int] = mapped_column(Integer, primary_key=True)
