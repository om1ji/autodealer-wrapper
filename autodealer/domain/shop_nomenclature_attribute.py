"""SQLAlchemy 2.0 ORM model for the shop_nomenclature_attribute table. AUTO-GENERATED — do not edit manually."""
...
class ShopNomenclatureAttribute(Base):
    __tablename__ = "shop_nomenclature_attribute"
