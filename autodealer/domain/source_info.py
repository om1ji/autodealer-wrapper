"""SQLAlchemy 2.0 ORM model for the source_info table. AUTO-GENERATED — do not edit manually."""
...
class SourceInfo(Base):
    ...
    source_info_id: Mapped[int] = mapped_column(Integer, primary_key=True)
