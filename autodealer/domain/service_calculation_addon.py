"""SQLAlchemy 2.0 ORM model for the service_calculation_addon table. AUTO-GENERATED — do not edit manually."""
...
class ServiceCalculationAddon(Base):
    __tablename__ = "service_calculation_addon"

    service_calculation_addon_id: Mapped[int] = mapped_column(Integer, primary_key=True)
