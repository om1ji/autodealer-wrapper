"""SQLAlchemy 2.0 ORM model for the document_planning_attribute table. AUTO-GENERATED — do not edit manually."""
...
class DocumentPlanningAttribute(Base):
    __tablename__ = "document_planning_attribute"
