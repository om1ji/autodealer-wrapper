"""SQLAlchemy 2.0 ORM model for the code_bk table. AUTO-GENERATED — do not edit manually."""
...
class CodeBk(Base):
    __tablename__ = "code_bk"

    code_bk_id: Mapped[int] = mapped_column(Integer, primary_key=True)
