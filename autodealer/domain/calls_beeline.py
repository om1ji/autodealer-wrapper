"""SQLAlchemy 2.0 ORM model for the calls_beeline table. AUTO-GENERATED — do not edit manually."""
...
class CallsBeeline(Base):
    __tablename__ = "calls_beeline"

    calls_beeline_id: Mapped[int] = mapped_column(Integer, primary_key=True)
    ...
    event_user_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    recorded: Mapped[Optional[int]] = mapped_column(SmallInteger, nullable=True)
