"""SQLAlchemy 2.0 ORM model for the order_provider_doc_attribute table. AUTO-GENERATED — do not edit manually."""
...
class OrderProviderDocAttribute(Base):
    __tablename__ = "order_provider_doc_attribute"
