"""SQLAlchemy 2.0 ORM model for the cloud_abcp_user_client table. AUTO-GENERATED — do not edit manually."""
...
class CloudAbcpUserClient(Base):
    __tablename__ = "cloud_abcp_user_client"
