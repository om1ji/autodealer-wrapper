"""SQLAlchemy 2.0 ORM model for the calls_telphin table. AUTO-GENERATED — do not edit manually."""
...
class CallsTelphin(Base):
    __tablename__ = "calls_telphin"

    calls_telphin_id: Mapped[int] = mapped_column(Integer, primary_key=True)
    ...
    rec_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
